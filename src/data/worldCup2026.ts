...
export const WORLD_CUP_2026_MATCHES: Omit<Match, 'id'>[] = [
  ...
  // ══════════════════════════════════════════
  // HUITIÈMES DE FINALE — à partir du 1er juillet
  // ══════════════════════════════════════════
  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-01T19:00:00Z', competition: 'Huitième 1', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-01T23:00:00Z', competition: 'Huitième 2', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-02T19:00:00Z', competition: 'Huitième 3', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-02T23:00:00Z', competition: 'Huitième 4', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-03T19:00:00Z', competition: 'Huitième 5', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-03T23:00:00Z', competition: 'Huitième 6', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-04T19:00:00Z', competition: 'Huitième 7', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-04T23:00:00Z', competition: 'Huitième 8', phase: 'Huitièmes de finale',
    status: 'upcoming' },

  // ══════════════════════════════════════════
  // QUARTS DE FINALE — à partir du 8 juillet
  // ══════════════════════════════════════════
  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-08T23:00:00Z', competition: 'Quart 1', phase: 'Quarts de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-09T23:00:00Z', competition: 'Quart 2', phase: 'Quarts de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-10T23:00:00Z', competition: 'Quart 3', phase: 'Quarts de finale',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-11T23:00:00Z', competition: 'Quart 4', phase: 'Quarts de finale',
    status: 'upcoming' },
  ...
  // ══════════════════════════════════════════
  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-14T23:00:00Z', competition: 'Demi-finale 1', phase: 'Demi-finales',
    status: 'upcoming' },

  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-15T23:00:00Z', competition: 'Demi-finale 2', phase: 'Demi-finales',
    status: 'upcoming' },
  ...
  // ══════════════════════════════════════════
  { homeTeam: { name: 'À déterminer' }, awayTeam: { name: 'À déterminer' },
    date: '2026-07-19T20:00:00Z', competition: 'Finale', phase: 'Finale',
    status: 'upcoming' },
];
