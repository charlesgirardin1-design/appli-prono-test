    ...
    return (
          <>
                ...
                <div className="app-content">
                        <Routes>
                                  <Route path="/" element={<PrivateRoute><Home /></PrivateRoute>PrivateRoute>} />
                                            <Route path="/classement" element={<PrivateRoute><Classement /></PrivateRoute>PrivateRoute>} />
                                                      <Route path="/groupes" element={<PrivateRoute><Groupes /></PrivateRoute>PrivateRoute>} />
                                                                <Route path="/favoris" element={<PrivateRoute><Favoris /></PrivateRoute>PrivateRoute>} />
                                                                          <Route path="/parametres" element={<PrivateRoute><ParametresPage /></PrivateRoute>PrivateRoute>} />
                                                                                    <Route path="/profil" element={<PrivateRoute><ProfilPage /></PrivateRoute>PrivateRoute>} />
                                                                                              <Route path="/champion" element={<PrivateRoute><ChampionPage /></PrivateRoute>PrivateRoute>} />
                                                                                                        <Route path="/test" element={<AdminRoute><TestPage /></AdminRoute>AdminRoute>} />
                                                                                                                  <Route path="/admin" element={<AdminRoute><AdminPage /></AdminRoute>AdminRoute>} />
                                                                                    ...
                                                                                    export default function App() {
                                                                                        if (!GOOGLE_CLIENT_ID) {
                                                                                              return <ErrorBoundary><AppCore /></ErrorBoundary>ErrorBoundary>;
                                                                                      }
                                                                                      return (
                                                                                        <ErrorBoundary>
